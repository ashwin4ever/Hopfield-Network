...
def train(patterns):
      ...
      dhnet = algorithms.DiscreteHopfieldNetwork(mode='async' , n_times = 2500 , check_limit = False , rule = 'oja')
...
#print(t_abc.reshape((n_cols , n_cols)))

i = 0
##while i < 5:
##      print('Learning Pattern: ABC')
##      tot_test_patterns = np.concatenate([tot_test_patterns , t_abc])
##      i += 1
